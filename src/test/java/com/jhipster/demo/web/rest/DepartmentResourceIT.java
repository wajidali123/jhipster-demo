...
import com.jhipster.demo.domain.Department;
import com.jhipster.demo.repository.DepartmentRepository;
import com.jhipster.demo.service.DepartmentService;
import com.jhipster.demo.service.dto.DepartmentDTO;
import com.jhipster.demo.service.mapper.DepartmentMapper;
...
public class DepartmentResourceIT {
    ...
    private static final String DEFAULT_DEPT_LOC = "AAAAAAAAAA";
    private static final String UPDATED_DEPT_LOC = "BBBBBBBBBB";

    private static final String DEFAULT_DEPT_CONTACT = "AAAAAAAAAA";
    private static final String UPDATED_DEPT_CONTACT = "BBBBBBBBBB";
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department()
            ...
            .deptLoc(DEFAULT_DEPT_LOC)
            .deptContact(DEFAULT_DEPT_CONTACT)
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department department = new Department()
            ...
            .deptLoc(UPDATED_DEPT_LOC)
            .deptContact(UPDATED_DEPT_CONTACT)
    ...
    public void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getDeptLoc()).isEqualTo(DEFAULT_DEPT_LOC);
        assertThat(testDepartment.getDeptContact()).isEqualTo(DEFAULT_DEPT_CONTACT);
    ...
    public void getAllDepartments() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].deptLoc").value(hasItem(DEFAULT_DEPT_LOC)))
            .andExpect(jsonPath("$.[*].deptContact").value(hasItem(DEFAULT_DEPT_CONTACT)))
    ...
    public void getDepartment() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments/{id}", department.getId()))
            ...
            .andExpect(jsonPath("$.deptLoc").value(DEFAULT_DEPT_LOC))
            .andExpect(jsonPath("$.deptContact").value(DEFAULT_DEPT_CONTACT))
    ...
    public void updateDepartment() throws Exception {
        ...
        assertThat(testDepartment.getDeptLoc()).isEqualTo(UPDATED_DEPT_LOC);
        assertThat(testDepartment.getDeptContact()).isEqualTo(UPDATED_DEPT_CONTACT);
